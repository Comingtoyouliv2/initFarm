...
/* Wallet list removed — InterwovenKit handles wallet selection via its built-in modal */
/* ─── Demo Chat Responses ─── */
...
/* ─── Connect Wallet Side Panel (InterwovenKit) ─── */
function WalletPanel({ onClose }) {
  const kit = useInterwovenKit();
  const [error, setError] = useState(null);
  const CHAIN_ID = "interwoven-1";

  /* Use InterwovenKit's built-in connect modal */
  const handleConnect = () => {
    onClose();
    kit.openConnect();
  };
  ...
  const toggleAutoSign = async () => {
    try {
      if (kit.autoSign.isEnabledByChain[CHAIN_ID]) {
        await kit.autoSign.disable(CHAIN_ID);
      ...
      setError(err.message || "Auto-sign toggle failed.");
    }
  };
          ...
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              <h3 style={{ fontSize: 18, fontWeight: 600, color: T.text, margin: 0 }}>
                {kit.isConnected ? "Wallet" : "Connect Wallet"}
              </h3>
              <span style={{
                fontSize: 9, fontWeight: 700, padding: "2px 8px", borderRadius: 6,
                background: "linear-gradient(135deg, #E8E0F0, #D4E8F0)",
                color: "#6B5CE7", letterSpacing: "0.5px",
              }}>InterwovenKit</span>
            </div>
            <p style={{ fontSize: 13, color: T.textMuted, margin: "4px 0 0" }}>
              {kit.isConnected ? "Manage your Initia wallet" : "Sign in via Initia's Interwoven Stack"}
            </p>
          </div>
          ...
          {kit.isConnected ? (
            ...
            <div>
              ...
              <div style={{
                ...
                <h4 style={{ fontSize: 18, fontWeight: 600, color: T.text, margin: "0 0 6px" }}>Connected</h4>
                {kit.username && (
                  <p style={{
                    fontSize: 15, fontWeight: 600, color: T.purple, margin: "0 0 8px",
                    display: "flex", alignItems: "center", justifyContent: "center", gap: 6,
                  }}>
                    <span style={{ fontSize: 12 }}>@</span> {kit.username}
                  </p>
                )}
                <p style={{
                  ...
                  wordBreak: "break-all",
                }}>{shortenAddr(kit.address)}</p>
              </div>

              {/* ── Auto-Sign Session (Initia-native feature) ── */}
              <div style={{
                padding: "20px",
                background: T.card, borderRadius: 16,
                border: `1px solid ${T.cardBorder}`,
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
                  <div>
                    <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 4 }}>
                      <span style={{ fontSize: 15, fontWeight: 600, color: T.text }}>Auto-Sign Session</span>
                      <span style={{
                    ...
                    <p style={{ fontSize: 12, color: T.textMuted, margin: 0, lineHeight: 1.5 }}>
                      Skip approval popups for routine transactions. Powered by Initia's session key infrastructure.
                    </p>
                  </div>
                </div>
                <button onClick={toggleAutoSign} style={{
                  width: "100%", padding: "12px 20px", borderRadius: 12,
                  border: "none",
                  background: kit.autoSign.isEnabledByChain[CHAIN_ID]
                ...
                {kit.autoSign.isEnabledByChain[CHAIN_ID] && (
                  <p style={{ fontSize: 11, color: T.green, margin: "8px 0 0", textAlign: "center" }}>
                    Session active on interwoven-1 \u2022 Transactions are auto-signed
                  </p>
                )}
              </div>
              ...
              <div style={{
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  <span style={{ fontSize: 13, color: T.textSoft }}>Network</span>
                  <span style={{ fontSize: 13, fontWeight: 600, color: T.text }}>Initia (interwoven-1)</span>
                </div>
                <div style={{ width: "100%", height: 1, background: T.cardBorder, margin: "10px 0" }} />
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  <span style={{ fontSize: 13, color: T.textSoft }}>Stack</span>
                  <span style={{ fontSize: 13, fontWeight: 600, color: T.text }}>Interwoven Rollup</span>
                </div>
              </div>
            ...
            /* ── Not connected — delegate to InterwovenKit's modal ── */
            <>
              <div style={{ textAlign: "center", paddingTop: 32 }}>
                ...
                <h4 style={{ fontSize: 20, fontWeight: 600, color: T.text, margin: "0 0 10px" }}>
                  Connect to Initia
                </h4>
                <p style={{ fontSize: 14, color: T.textSoft, lineHeight: 1.7, margin: "0 0 32px", maxWidth: 300, marginLeft: "auto", marginRight: "auto" }}>
                  Sign in with social accounts or your preferred wallet via InterwovenKit.
                </p>

                {/* Primary connect button — opens InterwovenKit's built-in modal */}
              ...
              {/* Initia-native features info */}
              <div style={{
                marginTop: 32, padding: "16px 20px", borderRadius: 12,
                background: "linear-gradient(135deg, rgba(107,92,231,0.06), rgba(59,130,246,0.06))",
                border: "1px solid rgba(107,92,231,0.12)",
              }}>
                <p style={{ fontSize: 13, fontWeight: 600, color: T.text, margin: "0 0 8px" }}>
                  Powered by Initia's Interwoven Stack
                </p>
                <div style={{ fontSize: 12, color: T.textSoft, lineHeight: 1.6 }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 4 }}>
                    <span style={{ color: T.green }}>{"\u2713"}</span> Social login via Privy
                  </div>
                  <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 4 }}>
                    <span style={{ color: T.green }}>{"\u2713"}</span> Auto-Sign sessions for seamless UX
                  </div>
                  <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 4 }}>
                    <span style={{ color: T.green }}>{"\u2713"}</span> Interwoven Bridge for cross-rollup transfers
                  </div>
                  <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                    <span style={{ color: T.green }}>{"\u2713"}</span> .init usernames supported
                  </div>
                </div>
              </div>
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <button onClick={onWallet} className="nav-btn-secondary" style={{
              ...
              border: kit.isConnected ? `1px solid ${T.greenBorder}` : "1px solid rgba(0,0,0,0.08)",
              background: kit.isConnected ? T.greenSoft : "rgba(245,243,238,0.5)",
              color: kit.isConnected ? T.green : T.text, fontWeight: 500, fontSize: 14,
              cursor: "pointer", fontFamily: "inherit",
              display: "flex", alignItems: "center", gap: 6,
              transition: "all 0.2s cubic-bezier(0.4,0,0.2,1)",
              boxShadow: "0 1px 4px rgba(0,0,0,0.03)",
            }}>{kit.isConnected ? shortenAddr(kit.username || kit.address) : <>{Icons.wallet} Connect</>}</button>
          </div>
        </div>
      </nav>
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
            ...
            <button onClick={onWallet} className="pill-btn-wallet" style={{
              ...
              border: kit.isConnected ? `1px solid ${T.greenBorder}` : "1px solid rgba(0,0,0,0.06)",
              background: kit.isConnected ? "rgba(240,253,244,0.8)" : "rgba(245,243,238,0.6)",
              color: kit.isConnected ? T.green : T.text, fontWeight: 500, fontSize: 13,
              cursor: "pointer", fontFamily: "inherit",
...
function Features() {
  ...
  return (
    <section id="features" style={{ padding: "100px 48px", maxWidth: 1120, margin: "0 auto" }}>
      ...
      {/* APY Verification - integrated hero card */}
      <div style={{
        padding: "44px 40px", borderRadius: T.radiusLg, marginBottom: 16,
        background: `linear-gradient(135deg, ${T.bgWarm} 0%, ${T.card} 100%)`,
        border: `1px solid ${T.cardBorder}`,
      }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 24 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            <div style={{
              width: 44, height: 44, borderRadius: 12,
              background: "rgba(0,0,0,0.04)", color: T.text,
              display: "flex", alignItems: "center", justifyContent: "center",
            }}>{Icons.verify}</div>
            <div>
              <h3 style={{ fontSize: 20, fontWeight: 600, color: T.text, margin: 0 }}>APY Verification</h3>
              <p style={{ fontSize: 13, color: T.textMuted, margin: "2px 0 0" }}>Core Engine</p>
            </div>
          </div>
          <span style={{
            fontSize: 10, fontWeight: 600, color: T.textMuted, textTransform: "uppercase",
            letterSpacing: "1.5px", padding: "5px 12px", borderRadius: 100,
            background: "rgba(0,0,0,0.03)", border: "1px solid rgba(0,0,0,0.06)",
          }}>Live On-Chain Data</span>
        </div>
        <p style={{ fontSize: 15, color: T.textSoft, lineHeight: 1.7, margin: "0 0 28px", maxWidth: 640 }}>
          ...
          {riskFactors.map((f) => (
            f.label === "more" ? (
              ...
              <div key={f.label} style={{
                ...
                <p style={{ fontSize: 13, fontWeight: 600, color: T.text, margin: "0 0 3px" }}>{f.label}</p>
                <p style={{ fontSize: 12, color: T.textMuted, margin: 0, lineHeight: 1.4 }}>{f.desc}</p>
              </div>
            )
          ))}
        </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 16 }}>
        {items.map((item) => <FeatureCard key={item.title} item={item} />)}
      </div>
    </section>
  );
}
...
function CTA({ onDemo }) {
  return (
    <section style={{
      ...
      background: `linear-gradient(180deg, ${T.bg} 0%, ${T.bgWarm} 40%, #EDE8E0 100%)`,
      textAlign: "center",
    }}>
...
function Footer() {
  return (
    <footer style={{
      padding: "0 0 60px", background: "#EDE8E0", position: "relative", overflow: "hidden",
    }}>
      {/* Links row */}
      <div style={{
        maxWidth: 1120, margin: "0 auto", padding: "60px 48px 64px",
        ...
        <div>
          ...
          <p style={{ fontSize: 13, color: T.textMuted, margin: "8px 0 0", maxWidth: 220, lineHeight: 1.5 }}>
            AI-powered DeFi yield farming on Initia
          </p>
        </div>
        <div style={{ display: "flex", gap: 56 }}>
          {[
            { title: "Product", links: ["Pool Table", "AI Agent", "Risk Model"] },
            { title: "Build", links: ["Smart Contract", "InterwovenKit", "Docs"] },
            { title: "Community", links: ["GitHub", "Discord", "Twitter"] },
          ].map((col) => (
            <div key={col.title}>
              <p style={{ fontSize: 11, fontWeight: 600, color: T.textMuted, textTransform: "uppercase", letterSpacing: "1.5px", margin: "0 0 14px" }}>{col.title}</p>
              {col.links.map((link) => (
                <p key={link} style={{ fontSize: 14, color: T.textSoft, margin: "0 0 10px", cursor: "pointer" }}>{link}</p>
              ))}
            </div>
          ))}
        </div>
      ...
      {/* Big initFarm text with mining mascot */}
...
/* ─── App ─── */
/* Production: wrap AppInner with real InterwovenKitProvider,
   WagmiProvider, and QueryClientProvider. See PRODUCTION_SETUP.md */
